	...
	<form action="bupdate.bo" method="post" enctype="Multipart/form-data">
		...
		<table id="boardUpdateTable" border="1">
			...
			<tr>
				<th>작성자</th>
				<td>
					<input type="hidden" name="boardWriter" readonly value="${ board.boardWriter }" style="background: lightgrey;">
					<input type="text" name="nickName" readonly value="${ board.nickName }" style="background: lightgrey;">
				</td>
			</tr>
			<tr>
				<th>내용</th>
