...
<body>
	...
	<script>
		$('#rSubmit').click(function(){
			...
			$.ajax({
				...
				success:function(data){
					console.log(data);
					if(data == 'success'){
						var rList = getReplyList();	//댓글 작성 성공 시 다시 댓글 리스트를 가져오는 것.
		...
		function login(){
			var id = document.getElementById('id인풋아이디값').value;
			var pw = document.getElementById('pw인풋아이디값').value;
			...
			$.ajax({
				...
				success:function(data){
					console.log(data);
					if(data == 'success'){	//컨트롤러에서 result가 1일시 success반환
